...
### outputs a list of the unique sequences and the number of times each occurs
### also ouputs a csv tables containing the total number of reads, the number of unique reads and the percent unique
