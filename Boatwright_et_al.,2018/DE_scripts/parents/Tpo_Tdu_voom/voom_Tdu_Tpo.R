...
print(dim(d))
#print(head(d))
colnames(d) <- c("Tdu_1","Tdu_2","Tdu_3","Tpo_1","Tpo_2","Tpo_3")
...
trt = factor(c(1,1,1,2,2,2), labels=c("Tdu","Tpo"))
...
contrast.matrix = makeContrasts(contrasts=c("trtTdu-trtTpo"), levels=design)
